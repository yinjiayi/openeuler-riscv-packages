...
%changelog
* Mon Sep 07 2026 openEuler RISC-V Maintainers <noreply@example.invalid> - 0.1.2-3
- Configure, build, install, and check one explicit out-of-source CMake directory.

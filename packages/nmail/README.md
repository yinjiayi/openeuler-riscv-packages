...
Release `4` declares the complete fixed-repository development dependency
...
features remain enabled. The upstream root build does not register CTest cases
in this release; the package retains its existing CTest invocation unchanged.

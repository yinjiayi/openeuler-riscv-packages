...
This directory packages nanomsg `1.2.5` for openEuler 24.03 LTS SP3 on
`riscv64`/RVA23. The official `1.2.5` tag resolves to immutable commit
`85856cb785ba6dd38c5e9757298a54d1bca55580`; its SHA-256-pinned archive is
...
official tag establishes current 1.2.5. Read-only AUR RPC metadata was
...
consumer; upstream ships `libnanomsg.so.6` (full ABI 6.0.1).

...
This directory packages XZ Utils `5.8.4` for openEuler 24.03 LTS SP3 on
...
were never executed. CI allows network access to retrieve the declared
official source and verifies its pinned SHA-256 before building. The build
runs the complete upstream test suite, and the installed smoke test exercises both command-line

...
Name:           plasma6-runners-markdown-bookmarks
Version:        0.5.1
Release:        1%{?dist}
Summary:        A Krunner plugin to open web links listed in a Markdown file
License:        GPL-3.0-or-later
URL:            https://github.com/andrewrabert/krunner-markdown-bookmarks
Source0:        plasma6-runners-markdown-bookmarks-0.5.1.tar.gz
BuildRequires:  cmake
BuildRequires:  gcc
BuildRequires:  gcc-c++
BuildRequires:  make

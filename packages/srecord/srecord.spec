...
Patch0:         0001-make-generated-documentation-optional.patch
...
export SHELL=/bin/sh
%cmake_conf -DSRECORD_BUILD_DOCUMENTATION=OFF
%cmake_build
...
for section in 1 3 5; do
  install -d "%{buildroot}%{_mandir}/man${section}"
  install -m 0644 "doc/man${section}/"* \

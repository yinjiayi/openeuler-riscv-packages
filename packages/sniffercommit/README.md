...
Release 3 supplies explicit `-S` and `-B` paths because upstream rejects in-source builds. Configure, build, install, and the complete CTest suite all use `%{_vpath_builddir}`.

...
%changelog
* Tue Sep 08 2026 openEuler RISC-V Maintainers <noreply@example.invalid> - 5.6.3-3
- Use the repository's out-of-source CMake configure macro.

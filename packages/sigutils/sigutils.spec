...
%changelog
* Sun Sep 06 2026 openEuler RISC-V Maintainers <noreply@example.invalid> - 0.3.0-8
- Express the NCQO cache repair with balanced strict context accepted by the
  target GNU patch implementation at zero fuzz.

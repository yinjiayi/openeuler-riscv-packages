...
%changelog
* Sat Sep 12 2026 openEuler RISC-V Maintainers <noreply@example.invalid> - 25.07.0-7
- Allow 240 minutes after the full QEMU build reached 88% at the prior deadline.

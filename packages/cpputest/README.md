...
`%check` enables the complete upstream CMake test gate in detailed mode and
runs all 77 registered CTest cases. The installed smoke test compiles and runs
a real CppUTest test against the installed library.

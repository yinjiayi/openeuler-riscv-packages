...
%check
# A single long-lived ctest process receives SIGILL under QEMU user mode after
# completing 69 tests.  Keep the full upstream suite, but bound each ctest
# process to 32 tests so emulator state is periodically renewed.

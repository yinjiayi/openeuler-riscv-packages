...
Version:        1.1.3
Release:        1%{?dist}
Summary:        A backend implementation for xdg-desktop-portal using GTK and various pieces of Cinnamon/MATE/Xfce4 infrastructure
License:        LGPL-2.1-or-later
URL:            https://github.com/linuxmint/xdg-desktop-portal-xapp
Source0:        xdg-desktop-portal-xapp-1.1.3.tar.gz
BuildRequires:  gcc
BuildRequires:  make
BuildRequires:  meson

...
Patch1:         0002-fix-user-controlled-format-string.patch
BuildRequires:  cmake
BuildRequires:  gcc
BuildRequires:  make
...
%changelog
* Tue Sep 08 2026 openEuler RISC-V Maintainers <noreply@example.invalid> - 0.1.3-4
- Preserve format-security hardening by treating resolution input as data.
